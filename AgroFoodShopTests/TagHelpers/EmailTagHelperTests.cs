...
namespace AgroFoodShopTests.TagHelpers
{
    public class EmailTagHelperTests
    {
        ...
        {
            EmailTagHelper emailTagHelper = new EmailTagHelper() { Address = "test@agrofoodshop.com", Content = "Email" }; ;
            ...
            Assert.Equal("mailto:test@agrofoodshop.com", tagHelperOutput.Attributes[0].Value);
        }
